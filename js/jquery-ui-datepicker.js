...
$.extend( Datepicker.prototype, {
	...
	_generateHTML: function( inst ) {
		...
		buttonPanel = ( showButtonPanel ) ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + ( isRTL ? controls : "" ) +
			...
			">" + currentText + "</button>" : "" ) + "<button class='ui-datepicker-clear ui-priority-secondary ui-corner-all' type='button' data-handler='clear' data-event='click'>Clear</button>" + ( isRTL ? "" : controls ) + "</div>" : "";
