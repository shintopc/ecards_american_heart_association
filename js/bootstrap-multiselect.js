    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    return this.nonSelectedText + ' <strong class="caret"></strong>';
                }
                else if (options.length == $('option', $(select)).length) {
                    return this.allSelectedText + ' <strong class="caret"></strong>';
                }
                else if (options.length > this.numberDisplayed) {
                    return options.length + ' ' + this.nSelectedText + ' <strong class="caret"></strong>';
                }
                else {
                    var selected = '';
                    ...
                    return selected.substr(0, selected.length - 2) + ' <strong class="caret"></strong>';
                }
            },
            /**
